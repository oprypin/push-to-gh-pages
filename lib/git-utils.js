    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            for (var files_1 = __asyncValues(files), files_1_1; files_1_1 = yield files_1.next(), !files_1_1.done;) {
                ...
                const filePublishPath = path_1.default.join(publishDir, file);
                const fileDestPath = path_1.default.join(destDir, file);
                const destPath = path_1.default.dirname(fileDestPath);
                if (fs_1.default.existsSync(destPath) === false) {
                    yield utils_1.createDir(destPath);
                }
                core.info(`[INFO] copy ${file}`);
                yield io.cp(filePublishPath, fileDestPath, copyOpts);
            }
        }
